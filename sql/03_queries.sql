...
SELECT TOP 10 customer_name, SUM(o.quantity * o.sell_price) AS revenue
FROM Orders o
JOIN Customers c ON o.customer_id = c.customer_id
...
SELECT YEAR(o.date) AS year, MONTH(o.date) AS month, SUM(o.quantity * o.sell_price) AS revenue
from Orders o
...
SELECT TOP 5 supplier_name, SUM(o.quantity * o.sell_price) AS total_revenue_generated
from Orders o
JOIN Products p ON o.product_id = p.product_id
